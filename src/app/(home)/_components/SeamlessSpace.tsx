  ...
  return (
    <section className=" bg-white px-[clamp(1rem,5vw,112px)] pt-15.5 ">
      ...
      <section className="w-full py-10 flex justify-center">
        <div className="grid grid-cols-3 grid-rows-3 gap-6 max-w-6xl w-full">
          {/* Top left card */}
          <div className="rounded-2xl overflow-hidden relative  col-span-1 row-span-1">
          ...
          {/* Top middle card */}
          <div className="rounded-2xl overflow-hidden relative col-span-1 row-span-2 bg-white">
          ...
          {/* Top right card */}
          <div className="rounded-2xl overflow-hidden relative  col-span-1 row-span-3">
            <Image
          ...
          {/* Bottom left card */}
          <div className="rounded-2xl overflow-hidden relative col-span-1 row-span-2 bg-[#EAF3FB] px-6 py-11 flex flex-col justify-end">
